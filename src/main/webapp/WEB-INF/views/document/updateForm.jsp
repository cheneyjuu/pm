...
<div class="container markdown">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="${ctx}/documents/update" method="post">
                <input type="hidden" name="documentId" value="${document.id}"/>
                <div class="row document-content">
                    <div class="col-md-6 clean-padding-r clean-padding-l">
                        <input type="text" name="title" id="title" class="input-no-bordered title" value="${document.title}"/>
                        <ul class="toolbar">
                        ...
                        <textarea name="originArticle" id="text-input" class="form-control" rows="25">${document.originArticle}</textarea>
                    ...
                    <div class="col-md-6 clean-padding-l clean-padding-r">
                        <div id="preview" class="well">${document.article}</div>
                    </div>
                    <div class="form-group">
                        <label for="documentDescription">项目描述</label><textarea name="description" id="documentDescription" class="form-control" rows="5">${document.description}</textarea>
                    </div>
                </div>
            </form>
            <hr/>
